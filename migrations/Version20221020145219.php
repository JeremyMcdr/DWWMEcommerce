 ...
 */
final class Version20221020145219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD user_id INT DEFAULT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD carrier_name VARCHAR(255) NOT NULL, ADD carrier_price DOUBLE PRECISION NOT NULL, ADD delivery LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP user_id, DROP created_at, DROP carrier_name, DROP carrier_price, DROP delivery');
    }
}
